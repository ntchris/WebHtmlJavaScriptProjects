   ...
   "C:\Program Files (x86)\RIM\BBBWebWorksSDKforTabletOS2.0.0.4\bbwp\bbwp\blackberry-tablet-sdk\bin\blackberry-deploy"  -installApp -password  xddx -device  169.254.0.253  -package F:\source\PBChChess2011\PBChChessPkg.bar -devmode
