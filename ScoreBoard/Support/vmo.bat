   ...
   "C:\Program Files\Research In Motion\BlackBerry WebWorks SDK for TabletOS 2.1.0.6\bbwp\blackberry-tablet-sdk\bin\blackberry-deploy"  -installApp -password  playbook -device  192.168.147.135  -package d:\source\PBChChess2011\PBChChessPkg.bar -devmode
